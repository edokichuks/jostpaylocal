...
//           Map<String, dynamic> json, List<RatesInfo> rateList) =>
//       LoginModel(
...
//             ? []
//             : List<String>.from(json["banks"].map((x) => x)),
//         sellBanks: json["sell_banks"] == null
//             ? []
//             : List<String>.from(json["sell_banks"].map((x) => x)),
//       );
