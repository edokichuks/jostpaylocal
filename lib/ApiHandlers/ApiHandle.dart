...
//     http.Response response = await http.get(baseUrl, headers: setHeadersGet());
...
//     var baseUrl = Uri.http('api.changenow.io', '$url', params);
...
//     var baseUrl = Uri.http('api.changenow.io', '$url');
