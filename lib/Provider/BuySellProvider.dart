...
//       getOtpBool = false;
//       Helper.dialogCall
//           .showToast(context, "Something is wrong please try again.");
//       notifyListeners();
//     }
//   }
...
//             ratesInfoList
//                 .add(RatesInfo.fromJson(value['rates_info'][key], key));
//           });
...
//             var exListIndex = exchangeList.indexWhere(
//                 (element) => element["name"] == loginModel!.ratesInfo[i].name);
//             if (exListIndex != -1) {
...
//               var sellMainValue =
//                   sellValue.split(".").last.split(" ")[1].trim();
...
//               List buyMainValue1 =
//                   buyValue1.split(".").last.split(" ").toList();
...
//               .split(" ");
//           receiveValue =
//               "${double.parse(data[0]).toStringAsFixed(3)} ${data[1].trim().split("\n").first}";
//         }
...
//         buyHistoryList.addAll(list
//             .where((element) => element.details.transactionType == "Buy")
//             .toList());
//         notifyListeners();
//       } else {
//         buyHistoryLoading = false;
...
//         sellHistoryList.addAll(list
//             .where((element) => element.details.transactionType == "Sell")
//             .toList());
...
//               minSellAmount =
//                   int.parse(myNewList[0]["minSellAmount"].toString());
//               notifyListeners();
//             }
//           }
...
//             List<String> list =
//                 List<String>.from(value['sell_banks'].map((x) => x));
...
//         // print("----> $e");
//         Helper.dialogCall
//             .showToast(context, "Something is wrong.Please letter");
...
//   var sellResponce;
//   sellOrder(params, accountId, BuildContext context, send,
//       Map<String, dynamic> sendData, coinName) async {
...
//         sellResponce = value;
//         var trxIndex = DbSellHistory.dbSellHistory.sellHistoryList
//             .indexWhere((element) => element.invoice == "${value['invoice']}");

//         if (trxIndex == -1) {
//           await DbSellHistory.dbSellHistory.createSellHistory(
//               SellHistoryModel.fromJson(
//                   value,
//                   accountId,
//                   coinName,
//                   params['bank'],
...
//                   params['bank'], params['account_no'], params['account_name']),
//               value["invoice"],
//               accountId);
//         }
...
//                   sendTokenDecimals:
//                       int.parse("${sendData['sendTokenDecimals']}"),
