class Utils {
  ...
  static String sellUrl =
      "https://instantexchangers.net/sell/final?transaction=";
  static String forgetPassword =
      "https://instantexchangers.net/forget-password";
  static Map<String, String> countryInfo = {
    "BD": "Bangladesh",
    "BE": "Belgium",
    "BF": "Burkina Faso",
    "BG": "Bulgaria",
