...
//     List<NewAccountList> list = res
//         .map<NewAccountList>((json) => NewAccountList.fromJson(json))
//         .toList();
...
//   createAccount(
//       String id, String deviceId, String name, String mnemonic) async {
//     final db = await database;
//     final res = await db!.rawInsert(
//         'INSERT INTO Account(id, device_id, name, mnemonic) VALUES("$id", "$deviceId", "$name", "$mnemonic")');
//     return res;
//   }
