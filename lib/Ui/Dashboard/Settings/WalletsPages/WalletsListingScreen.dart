...
//         if (mounted) {
//           setState(() {
//             String selectedAccountAddress = DbAccountAddress
//                 .dbAccountAddress.allAccountAddress[i].publicAddress;
//             String selectedAccountPrivateAddress = DbAccountAddress
...
//             Flexible(
//               child: Text("You want to delete this account?",
...
//     sharedPreferences.setString(
//         'accountId', DBAccountProvider.dbAccountProvider.newAccountList[0].id);
//     sharedPreferences.setString('accountName',
...
//           return InkWell(
//             onTap: () {
//               var seedPhase = DBAccountProvider
//                   .dbAccountProvider.newAccountList[index].mnemonic;
//               List seedPhaseList = [];
//               if (seedPhase != "") {
...
//                       accountId: DBAccountProvider
//                           .dbAccountProvider.newAccountList[index].id,
//                       seedPhare: seedPhaseList,
//                       name: DBAccountProvider
//                           .dbAccountProvider.newAccountList[index].name,
//                     ),
//                   ));
//             },
//             child: Container(
...
//                       color: selectedAccountId == list.id
//                           ? MyColor.greenColor
//                           : MyColor.greyColor,
//                     ),
//                     child: Image.asset(
...
//                   const SizedBox(width: 10),
//                   Visibility(
//                     visible: DBAccountProvider
//                             .dbAccountProvider.newAccountList.length >
//                         1,
...
//                                     : 'Set Default Wallet',
//                                 style:
//                                     MyStyle.tx18RWhite.copyWith(fontSize: 15),
//                               ),
//                             ],
//                           ),
//                         ),
