...
class _SecurityScreenState extends State<SecurityScreen> {
  ...
  changePasswordApi(bool passwordChange, context) async {
    ...
    if (!passwordChange) {
      ...
      newPassword =
          passwordType ? newPassCodeController.text : newPassController.text;
    }
                ...
                child: Column(
                  ...
                  children: [
                        ...
                        FlutterSwitch(
                          ...
                          onToggle: (val) async {
                            SharedPreferences sharedPreferences =
                                await SharedPreferences.getInstance();
                            var savePince2 =
                                sharedPreferences.getString("passcode") ?? "";
                            ...
                            if (savePince2 == "") {
                              ...
                              Helper.dialogCall.showToast(
                                  context, "Please set your passcode.");
                            } else {
                              setState(() {
                                passwordType = val;
                    ...
                    Text(
                      ...
                      style: MyStyle.tx18RWhite
                          .copyWith(fontSize: 13, color: MyColor.grey01Color),
                    ),
                                  ...
                                  TextFormField(
                                      ...
                                      validator: (value) {
                                        if (value!.isEmpty) {
                                          ...
                                          return "";
                                        } else if (setPassCodeController
                                                .text.length <
                                            6) {
                                          newRePassMess =
                                              "Passcode must be 6 digit";
                                          return "";
                                        } else if (value !=
                                            setRePassCodeController.text) {
                                          newRePassMess =
                                      ...
                                      decoration: MyStyle.textInputDecoration
                                          .copyWith(
                                      ...
                                      validator: (value) {
                                        if (value!.isEmpty) {
                                          ...
                                          newRePassMess =
                                              "Passcode must be 6 digit";
                                          return "";
                                        } else if (setPassCodeController.text !=
                                            value) {
                                          newRePassMess =
                                              "Passcode not matched!";
                                          return "";
                                    ...
                                    Visibility(
                                      ...
                                      child: TextFormField(
                                          ...
                                          validator: (value) {
                                            if (value!.isEmpty) {
                                              oldCodeError =
                                                  "please enter you passcode";
                                              return "";
                                            } else if (value != savePasscode) {
                                              oldCodeError =
                                                  "Entered old passcode not matched!";
                                              return "";
                                            } else {
                                              oldCodeError = "";
                                              return null;
                                        ...
                                        validator: (value) {
                                          if (value!.isEmpty) {
                                            ...
                                            return "";
                                              ...
                                              reNewPassCodeController.text) {
                                            newCodeError =
                                                "Entered passcode not matched!";
                                            return "";
                                          } else {
                                            newCodeError = "";
                                            return null;
                            ...
                            child: InkWell(
                              onTap: () {
                                if (pinNotSave) {
                                  if (newPassCodeKey.currentState!.validate()) {
                                    ...
                                    Helper.dialogCall.showToast(
                                        context, "Minimum 6 digit code");
                                  }
                                } else {
                                  if (passwordType) {
                                    if (passcodeFormKey.currentState!
                                        .validate()) {
                                      if (oldCodeError.isNotEmpty &&
                                          newCodeError.isNotEmpty &&
                                          reNewCodeError.isNotEmpty) {
                                        changePasswordApi(true, context);
                                      } else {
                                        Helper.dialogCall.showToast(
                                            context, "Minimum 6 digit code");
                                    ...
                                    if (passwordFormKey.currentState!
                                      ...
                                      Helper.dialogCall.showToast(context,
                                          "Please filed all details first");
                                    }
                                  }
                                }
                              },
                              child: Container(
                                ...
                                decoration: BoxDecoration(
                                    ...
                                    border:
                                        Border.all(color: MyColor.greenColor)),
                                child: Text(
                                  pinNotSave ? "Set " : "Reset",
                                  textAlign: TextAlign.center,
                                  style:
                                      MyStyle.tx28RGreen.copyWith(fontSize: 18),
                                ),
                              ),
                            ),
                          )
