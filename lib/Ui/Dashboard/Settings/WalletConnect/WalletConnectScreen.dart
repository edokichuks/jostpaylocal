                    ...
                    setState(() {
                      ...
                      if (a[1][0] == "1") {
                        Helper.dialogCall.showToast(context,
                            "Qr is not compatible with wallet connect v2 please use wallet connect v1 qr");
                      } else {
                              ...
                              return ListTile(
                                ...
                                onTap: () {
                                  Navigator.push(
                                      context,
                                      MaterialPageRoute(
                                        builder: (context) => signTransactions2(
                                            publicKey: value[idx].topic),
                                      ));
                                },
                                trailing: SizedBox(
                                  height: 50,
