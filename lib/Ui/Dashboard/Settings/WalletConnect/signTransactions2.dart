...
class signTransactions2 extends StatefulWidget {
  ...
  const signTransactions2({super.key, required this.publicKey});

  @override
  _signTransactions2State createState() => _signTransactions2State();
}

class _signTransactions2State extends State<signTransactions2>
  ...
  getSignT() {
    Future.delayed(const Duration(seconds: 1), () async {
      await DBWalletConnectV2.dbWalletConnectV2
          .getSignTByPublicKey(widget.publicKey);
      setState(() {
        isLoading = false;
      });
    });
  ...
  Widget build(BuildContext context) {
    WidgetsBinding.instance.addPostFrameCallback((_) {
      setState(() {
        DBWalletConnectV2.dbWalletConnectV2
            .getSignTByPublicKey(widget.publicKey);
      });
    });
      ...
      body: isLoading
          ...
          : DBWalletConnectV2.dbWalletConnectV2.SignTList.isEmpty
              ...
              : ListView.builder(
                  ...
                  reverse: true,
                  itemCount:
                      DBWalletConnectV2.dbWalletConnectV2.SignTList.length,
                        ...
                        children: [
                          Row(
                            ...
                            children: [
                              Expanded(
                                child: Text(
                                  "${DBWalletConnectV2.dbWalletConnectV2.SignTList[index]['date']}",
                                  style:
