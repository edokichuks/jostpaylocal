...
//         params, selectedAccountId, context, sendTokenSymbol);
...
//       selectTokenUSD =
//           double.parse(selectedCoin!.balance) * selectedCoin!.price;
...
//         .getPublicKey(selectedAccountId, selectedCoin!.networkId);
...
//       "to": selectedCoin!.networkId == 9
//           ? "TF2JHvbiHbLyUyP3GyfnEzvRCD3P66u6VZ"
//           : selectedAccountAddress,
//       "token_id": selectedCoin!.token_id,
//       "value": type == "max"
//           ? (double.parse(sendTokenBalance) * 0.50)
...
//           return element.networkId == selectedCoin!.networkId &&
//               element.type == "";
//         }).toList();

//         if (double.parse(tokenBalance[0].balance) <
...
//                               items: DBTokenProvider.dbTokenProvider.tokenList
//                                   .where((element) => element.type != "TRC20")
//                                   .map((AccountTokenList category) {
...
//                                     isMax = false;
//                                   }
//                                   usdAmount = (double.parse(value) *
//                                       double.parse(double.parse(sendTokenUsd)
//                                           .toStringAsFixed(2)));
//                                   if (usdAmount <
//                                       buySellProvider.minSellAmount) {
//                                     usdError =
//                                         "Min. ${buySellProvider.minSellAmount}";
//                                   } else {
//                                     usdError = "";
//                                   }
//                                 }
...
//                                         color: MyColor.redColor, fontSize: 14),
//                                   ),
//                                 )),
...
//                               dropdownColor: MyColor.backgroundColor,
//                               style: MyStyle.tx18RWhite.copyWith(fontSize: 16),
//                               items: buySellProvider.sellBankList
//                                   .map((String category) {
//                                 return DropdownMenuItem(
//                                     value: category,
//                                     child: Text(
