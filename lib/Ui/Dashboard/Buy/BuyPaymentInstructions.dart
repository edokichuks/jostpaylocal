...
class BuyPaymentInstructions extends StatefulWidget {
  ...
  BuyPaymentInstructions({super.key, required this.buyResponse});
...
class _BuyPaymentInstructionsState extends State<BuyPaymentInstructions> {
  ...
  notifyOrder(invoice) async {
    ...
    await buySellProvider.notifyOrder(params, context, "sell");
            ...
            children: [
              ListView.builder(
                ...
                itemBuilder: (context, index) {
                  var listItem = widget.buyResponse
                      .toString()
                      .substring(1, widget.buyResponse.toString().length - 1)
                      .split("\n");
                  var listNote = [];
                  var data = {
                    "info":
                        "Take NOTE ${listItem[0].split(',').last.split(":").last}",
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: Text(
                            data['bankName']!,
                            style: MyStyle.tx18RWhite.copyWith(fontSize: 13),
                          ),
                        ),
                        ...
                        InkWell(
                          onTap: () {
                            FlutterClipboard.copy(data['bankNo']!)
                                .then((value) {
                              Helper.dialogCall
                                  .showToast(context, "Account no Copied");
                            });
                          },
                          child: Container(
                            width: double.infinity,
              ...
              buySellProvider.notifyLoading
                  ...
                  : InkWell(
                      onTap: () {
                        var value = widget.buyResponse
                            .toString()
                            .substring(
                                1, widget.buyResponse.toString().length - 1)
                            .split("Invoice no :")
                            .last
                            .trim();
                        var invoice =
                            value.split(" ").first.split("\n").first.trim();
                        notifyOrder(invoice);
                      },
                      child: Container(
              ...
              Text(
                ...
                style: MyStyle.tx18RWhite
                    .copyWith(fontSize: 15, color: MyColor.whiteColor),
              )
            ],
          ),
        ));
