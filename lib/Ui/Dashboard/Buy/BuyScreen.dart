...
//                   items: buySellProvider.loginModel == null
//                       ? []
//                       : buySellProvider.loginModel!.ratesInfo
//                           .map((RatesInfo category) {
...
//                           int index =
//                               selectedCoin!.networkFees.indexOf(category);
//                           return DropdownMenuItem(
//                               value: category,
//                               child: Text(
...
//                   items: buySellProvider.loginModel == null
//                       ? []
//                       : buySellProvider.loginModel!.banks
//                           .map((String category) {
//                           return DropdownMenuItem(
//                               value: category,
//                               child: Text(
...
//                   },
//                   decoration: MyStyle.textInputDecoration.copyWith(
//                     hintText: selectedCoin == null
//                         ? "Currency account"
//                         : "${selectedCoin!.name} account",
//                     isDense: false,
//                     contentPadding: const EdgeInsets.symmetric(
//                         vertical: 15, horizontal: 15),
//                   ),
...
//                             selectedCoin!.minBuyAmount
//                     ? InkWell(
//                         onTap: () {
//                           // print(buySellProvider.loginModel!.accountVerified);
//                           if (buySellProvider.loginModel!.accountVerified ==
//                               "no") {
...
//                                         receivingAddress:
//                                             currencyAcController.text.trim(),
//                                         selectedCoin: selectedCoin,
//                                         memo: memoController.text.trim(),
//                                         networkFess: networkFees == null
//                                             ? "0"
//                                             : networkFees!,
//                                       )));
//                           if (value != null) {
...
//                           child:
//                               const Text("Continue", style: MyStyle.tx18BWhite),
//                         ),
//                       ),
//               ],
//             ),
