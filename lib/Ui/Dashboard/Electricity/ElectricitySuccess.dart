      ...
      body: Padding(
        ...
        child: Column(
          children: [
            ...
            Text(
              'Your electricity token purchase was',
              style: MyStyle.tx18Black.copyWith(color: const Color(0xFF565B66)),
            ),
            Text(
              'successful',
              style: MyStyle.tx18Black.copyWith(color: const Color(0xFF565B66)),
            ...
            GestureDetector(
              ...
              child: Text(
                'Share Receipt',
                style: MyStyle.tx16Green.copyWith(fontWeight: FontWeight.w600),
              ),
            )
          ],
        ),
