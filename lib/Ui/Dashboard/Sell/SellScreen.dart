...
class _SellScreenState extends State<SellScreen> {
  ...
  sellValidateOrder(context) async {
    ...
    var params = {
      ...
      // "token":"",
      "token": buySellProvider.loginModel == null
          ? ""
          : buySellProvider.loginModel!.accessToken,
    ...
    await buySellProvider.validateSellOrder(
        params, selectedAccountId, context, "");
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      DropdownButtonFormField<dynamic>(
                        ...
                        items: buySellProvider.sellRateList
                            .where(
                                (element) => element['name'] == "Perfectmoney")
                            .toList()
                            .map((dynamic tokenData) {
                      ...
                      DropdownButtonFormField<String>(
                        ...
                        style: MyStyle.tx18RWhite.copyWith(fontSize: 16),
                        items:
                            buySellProvider.sellBankList.map((String category) {
                          return DropdownMenuItem(
                              value: category,
                              child: Text(
                                category,
                      ...
                      buySellProvider.sellValidOrder
                          ...
                          : selectedCoin == null ||
                              ...
                              ? InkWell(
                                  onTap: () {
                                    if (double.parse(selectedCoin['amount']) <
