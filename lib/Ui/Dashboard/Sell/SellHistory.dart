...
//                     shrinkWrap: true,
//                     itemCount:
//                         DbSellHistory.dbSellHistory.sellHistoryList.length,
//                     itemBuilder: (context, index) {
//                       var list =
//                           DbSellHistory.dbSellHistory.sellHistoryList[index];
//                       return InkWell(
//                         onTap: () async {
...
//                               InkWell(
//                                 onTap: () {
//                                   FlutterClipboard.copy(list.invoice)
//                                       .then((value) {
