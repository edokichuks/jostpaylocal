                ...
                : InkWell(
                    onTap: () {
                      if (acceptTerms) {
                        ...
                        Helper.dialogCall
                            .showToast(context, "Accept terms and condition.");
                      }
                    },
                    child: Container(
          ...
          child: Column(
            ...
            children: [
              ListView.builder(
                ...
                shrinkWrap: true,
                itemCount: buySellProvider.getSellValidation['info']
                    .split("\n")
                    .length,
                itemBuilder: (context, index) {
                  var list = buySellProvider.getSellValidation['info']
                      .split("\n")[index];
                  return Visibility(
                    visible: index != 0 &&
                        index != 1 &&
                        index != 2 &&
                        index <
                            buySellProvider.getSellValidation['info']
                                    .split("\n")
                                    .length -
                                1,
                    child: Padding(
                        ...
                        children: [
                          Padding(
                            ...
                            child: Text(
                              ...
                              "${list.toString().split(":").first.substring(1, list.toString().split(":").first.length - 1).toLowerCase()}",
                              style: MyStyle.tx18RWhite.copyWith(fontSize: 12),
                            ),
                          ),
              ...
              RichText(
                text: TextSpan(
                  children: [
                    ...
                    TextSpan(
                      text:
                          "Please confirm your sell order and make sure all details"
