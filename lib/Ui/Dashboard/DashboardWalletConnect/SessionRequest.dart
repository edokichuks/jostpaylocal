...
//       // print(element.chain);
//       return "${element.chain}" == item.value.chains.first.split(":").last &&
//           element.isEVM == 1 &&
//           element.swapEnable == 1;
//     });
...
//                   shrinkWrap: true,
//                   itemCount: DbNetwork.dbNetwork.networkList
//                       .where((element) =>
//                           element.isEVM == 1 && element.swapEnable == 1)
//                       .toList()
//                       .length,
...
//                                 style:
//                                     MyStyle.tx18RWhite.copyWith(fontSize: 12),
//                               ),
//                             ],
//                           ))
//                         ],
...
//                             final List<String> accounts = [];
//                             List<NetworkList> evmList = DbNetwork
//                                 .dbNetwork.networkList
//                                 .where((element) {
//                               return element.isEVM == 1 &&
//                                   element.swapEnable == 1;
//                             }).toList();

//                             for (int i = 0; i < evmList.length; i++) {
//                               accounts.add(
//                                   "eip155:${evmList[i].chain}:${widget.account1}");
//                             }
