...
class _SellCoinScreenState extends State<SellCoinScreen> {
  ...
  getSellAmount() async {
    ...
    const String url =
        'https://instantexchangers.com/mobile_server/get-sell-amount';
    final prefs = await SharedPreferences.getInstance();
    String? token = prefs.getString("token");
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        Navigator.push(context, MaterialPageRoute(builder: (context) {
          return SellCoinConfirmScreen(
              bData: bankData, sData: sellInfo, cData: selectedCoin);
        }));
      } else {
        setState(() {
          isLoading = false;
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: CustomDropdown<Coin>.search(
                    ...
                    Row(
                      ...
                      children: [
                        Container(
                          ...
                          decoration:
                              const BoxDecoration(color: Color(0x5CD1D1D1)),
                        ),
                        Text("OR",
                            style: NewStyle.tx28White.copyWith(
