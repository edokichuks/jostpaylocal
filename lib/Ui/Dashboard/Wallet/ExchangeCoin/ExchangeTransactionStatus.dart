...
class ExchangeTransactionStatus extends StatefulWidget {
  ...
  const ExchangeTransactionStatus({super.key, required this.statusId});

  @override
  State<ExchangeTransactionStatus> createState() =>
      _ExchangeTransactionStatusState();
}
...
class _ExchangeTransactionStatusState extends State<ExchangeTransactionStatus> {
  ...
  getTxsStatus() async {
    ...
    setState(() {
      // set send token
      sendNetwork = exchangeProvider.tempExTokenList
          .where((element) {
            return element.ticker ==
                DbExTransaction.dbExTransaction.getTrxStatusData!.fromCurrency;
          })
          .toList()
          .first;

      receiveNetwork = exchangeProvider.tempExTokenList
          .where((element) {
            return element.ticker ==
                DbExTransaction.dbExTransaction.getTrxStatusData!.toCurrency;
          })
          .toList()
          .first;
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      children: [
                            ...
                            children: [
                              ...
                              Row(
                                children: [
                                  ...
                                  Text(
                                    DbExTransaction.dbExTransaction
                                        .getTrxStatusData!.status,
                                    style: MyStyle.tx18RWhite
                                        .copyWith(fontSize: 16),
                                  ),
                                ],
                              ...
                              InkWell(
                                onTap: () {
                                  FlutterClipboard.copy(DbExTransaction
                                          .dbExTransaction.getTrxStatusData!.id)
                                      .then((value) {
                              ...
                              // Tag id
                              Visibility(
                                visible: DbExTransaction.dbExTransaction
                                            .getTrxStatusData!.payinExtraId !=
                                        "" &&
                                    DbExTransaction
                                            .dbExTransaction
                                            .getTrxStatusData!
                                    ...
                                    onTap: () {
                                      FlutterClipboard.copy(DbExTransaction
                                        ...
                                        Helper.dialogCall.showToast(context,
                                            "${DbExTransaction.dbExTransaction.getTrxStatusData!.payinExtraIdName} Copied");
                                      });
                                    },
                                    child: Row(
                                      mainAxisAlignment: MainAxisAlignment.end,
                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  Flexible(
                                    child: Text(
                                      DbExTransaction.dbExTransaction
                                          .getTrxStatusData!.payoutAddress,
                        ...
                        Visibility(
                          visible: DbExTransaction
                                  .dbExTransaction.getTrxStatusData!.status ==
                              "waiting",
                          child: Column(
                            children: [
                              // warning message
                                  ...
                                  children: [
                                    Container(
                                      ...
                                      child: ClipRRect(
                                        borderRadius: BorderRadius.circular(10),
                                        child: QrImageView(
                                          data: DbExTransaction.dbExTransaction
                                              .getTrxStatusData!.payinAddress,
