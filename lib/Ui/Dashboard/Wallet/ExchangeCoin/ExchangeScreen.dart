...
//   const ExchangeScreen({super.key, this.tokenList});
...
//       setState(() {
//         exchangeProvider.changeSendToken(
//             widget.tokenList!, context, "oldValue");
//       });
//     }
//     setState(() {
//       isLoading = false;
...
//     var data = {"api_key": Utils.apiKey};
//     await exchangeProvider.estimateExchangeAmount(
//         "v1/exchange-amount/fixed-rate/${sendCoinController.text.trim()}/${sendSymbol}_$receiveSymbol",
//         data,
//         context);
//   }
...
//                   exchangeProvider.exRateLoading ||
//                   exchangeProvider.estimateLoading
//               ? Visibility(
...
//                   onTap: () async {
//                     if (showSendError ||
//                         exchangeProvider.getCoinController.text.isEmpty ||
//                         sendCoinController.text.isEmpty) {
//                       Helper.dialogCall
//                           .showToast(context, "Please provide all details");
//                     } else {
...
//         ],
//       ),
//       body: exchangeProvider.isLoading ||
//               exchangeProvider.exRateLoading ||
//               isLoading
...
//                                               exchangeProvider.minAmount) {
//                                             setState(() {
//                                               showSendError = true;
//                                               sendError =
//                                                   "Amount must be more then ${exchangeProvider.minAmount}";
//                                             });
//                                           } else if (exchangeProvider
//                                                       .maxAmount !=
//                                                   -1 &&
//                                               double.parse(value) >
//                                                   exchangeProvider.maxAmount) {
//                                             setState(() {
//                                               showSendError = true;
//                                               sendError =
//                                                   "Amount must be less then ${exchangeProvider.maxAmount}";
//                                             });
//                                           } else {
//                                             setState(() {
//                                               showSendError = false;
...
//                               sendError,
//                               style: MyStyle.tx18BWhite.copyWith(
//                                   color: MyColor.redColor, fontSize: 12),
//                             ),
//                           ),
//                         ),
...
//                                         controller:
//                                             exchangeProvider.getCoinController,
//                                         readOnly: true,
//                                         cursorColor: MyColor.greenColor,
//                                         style: MyStyle.tx18RWhite,
//                                         inputFormatters: <TextInputFormatter>[
