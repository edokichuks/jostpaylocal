            ...
            children: [
              ...
              TextFormField(
                ...
                decoration: NewStyle.dashboardInputDecoration.copyWith(
                    hintText: "${selectedToken ?? ""} Address",
                    suffixIcon: SizedBox(
                      width: 90,
                      child: Row(
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  borderRadius: BorderRadius.circular(5),
                  border: Border.all(
                    color: const Color(0xFF8C571E),
                    width: 1,
                  ),
                  color: const Color(0x808C571E),
                ),
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
