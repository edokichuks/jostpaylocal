...
//       {super.key, required this.invoice, required this.tokenName});
...
//                     border: Border.all(color: MyColor.grey01Color)),
//                 child: const Icon(Icons.check, color: MyColor.greenColor),
//               ),
...
//                 style: MyStyle.tx18BWhite.copyWith(fontSize: 17),
//               ),
//               const SizedBox(height: 20),
//               InkWell(
//                 onTap: () {
...
//                   child: const Center(
//                     child: Text("View History", style: MyStyle.tx18RWhite),
//                   ),
//                 ),
//               ),
