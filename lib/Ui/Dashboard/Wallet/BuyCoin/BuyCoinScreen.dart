...
class _BuyCoinScreenState extends State<BuyCoinScreen> {
  ...
  final TextEditingController _amountNGNController = TextEditingController();
  ...
  late Map<String, dynamic> coinFees = {'fast': 0, 'normal': 0};
  ...
  getBuyAmount() async {
    ...
    try {
      ...
      final response = await http.post(
          Uri.parse(
              'https://instantexchangers.com/mobile_server/get-buy-amount'), // Get Wallet Information,
          headers: {
  ...
  getCoinFees() async {
    try {
      ...
      final response = await http.post(
          Uri.parse(
              'https://instantexchangers.com/mobile_server/get-buy-fees'), // Get Wallet Information,
          headers: {'Authorization': 'Bearer $token'},
          body: {'coin_id': selectedCoin['coin_id']});
                      ...
                      children: [
                            ...
                            ? Column(
                                ...
                                children: [
                                  ...
                                  TextFormField(
                                      ...
                                      decoration: NewStyle.searchInputDecoration
                                          .copyWith(
                        ...
                        coinFees['fast'] != 0
                            ? DropdownButtonFormField<String>(
                                ...
                                isExpanded: true,
                                style:
                                    NewStyle.tx28White.copyWith(fontSize: 12),
                                decoration:
                                    NewStyle.searchInputDecoration.copyWith(
                                ...
                                dropdownColor: NewColor.dashboardPrimaryColor,
                                items:
                                    ["fast", "normal"].map((String category) {
                                  return DropdownMenuItem(
                                      value: category,
                                      child: Text(
                                        category,
                        ...
                        Container(
                            ...
                            decoration: BoxDecoration(
                                color: const Color(0x80825728),
                                borderRadius: BorderRadius.circular(5),
                                border: Border.all(
                                    width: 0.5,
                                    color: const Color(0x33D1D1D1))),
                            padding: const EdgeInsets.fromLTRB(0, 31, 0, 9),
                            child: Column(
                              children: [
                                Text(
                                ...
                                DottedBorder(
                                  ...
                                  child: Container(
                                    ...
                                    decoration: BoxDecoration(
                                        ...
                                        color: NewColor.btnBgGreenColor),
                                    child: Text(
                                      "${NumberFormat('#,###.####').format(coinAmount.toDouble())} ${coinType ?? "(Coin Type)"} = ${_amountController.text != "" ? _amountController.text : "0"}\$",
                                      style: NewStyle.tx28White.copyWith(
                                        fontSize: 12,
