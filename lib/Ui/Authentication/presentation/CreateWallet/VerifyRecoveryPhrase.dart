            ...
            children: [
              ...
              Text(
                ...
                style: MyStyle.tx22RWhite
                    .copyWith(color: MyColor.mainWhiteColor, fontSize: 25),
              ...
              Text(
                ...
                textAlign: TextAlign.center,
                style: MyStyle.tx22RWhite
                    .copyWith(fontSize: 17, color: MyColor.grey01Color),
              ),
              ...
              Text(
                ...
                textAlign: TextAlign.center,
                style: MyStyle.tx22RWhite
                    .copyWith(fontSize: 17, color: MyColor.whiteColor),
              ),
              ...
              Text(
                ...
                textAlign: TextAlign.center,
                style: MyStyle.tx22RWhite
                    .copyWith(fontSize: 17, color: MyColor.greenColor),
              ),
              ...
              InkWell(
                ...
                child: Container(
                  ...
                  child: const Text("Done", style: MyStyle.tx18BWhite),
                ),
              ),
            ],
          ),
      ...
      bottomNavigationBar: Column(
        ...
        children: [
          isLoading == true
              ...
              : InkWell(
                  onTap: () async {
                    if (firstId == firstSelectId &&
                        secondId == secondSelectId &&
                        thardId == thardSelectId) {
                      SharedPreferences sharedPreferences =
                          await SharedPreferences.getInstance();
                      ...
                      Helper.dialogCall.showToast(
                          context, "Confirm Seed Phrase Failed Try Again");
                    }
                  },
                  child: Container(
                    alignment: Alignment.center,
                    ...
                    padding: const EdgeInsets.symmetric(vertical: 12),
                    decoration: firstId == firstSelectId &&
                            secondId == secondSelectId &&
                            thardId == thardSelectId
