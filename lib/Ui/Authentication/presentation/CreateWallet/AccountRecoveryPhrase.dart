...
class AccountRecoveryPhrase extends StatefulWidget {
  ...
  AccountRecoveryPhrase(
      {super.key, required this.seedPhrase, required this.isNew});
          ...
          InkWell(
            onTap: () {
              ...
              for (int i = 0; randomFive.length < 3; i++) {
                ...
                var test = {"id": index + 1, "name": element};

                //print(test);

                int a = randomFive
                    .indexWhere((element) => element['id'] == test['id']);
                //  print("Index = $a");
            ...
            child: Container(
              ...
              child: const Text("Continue", style: MyStyle.tx18BWhite),
            ),
          ),
          ...
          child: SingleChildScrollView(
            child: Column(
              children: [
                ...
                InkWell(
                  onTap: () {
                    FlutterClipboard.copy(widget.seedPhrase.join(" "))
                        .then((value) {
                    ...
                    children: [
                      RichText(
                        ...
                        TextSpan(
                            text: "DO NOT ",
                            style: MyStyle.tx28BYellow.copyWith(
                                fontSize: 18, color: MyColor.whiteColor)),
                        const TextSpan(
                      ...
                      Text(
                        ...
                        style: MyStyle.tx18RWhite.copyWith(fontSize: 17.5),
                      )
                    ],
                  ),
                ),
