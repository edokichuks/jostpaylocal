        ...
        children: <Widget>[
          ...
          Padding(
            padding: const EdgeInsets.only(
                top: 61, left: 24, right: 24), // Set top padding here
            child: Align(
              ...
              child: LinearProgressBar(
                ...
                valueColor:
                    const AlwaysStoppedAnimation<Color>(MyColor.progressBar),
          ...
          Align(
            ...
            child: Container(
                ...
                decoration: BoxDecoration(
                  color:
                      Colors.black.withOpacity(0.6), // Black color with opacity
                ...
                child: Column(
                  children: [
                    ...
                    Row(
                      children: [
                        Image.asset(
                          "assets/images/splash/li-icon.png",
                          width: 36,
                          height: 36,
                        ),
                        const SizedBox(
                        ...
                        Text(
                          data[pageIndex]['detail1'],
                          style: MyStyle.tx18White,
                        )
                      ],
                    ),
                    const SizedBox(
                    ...
                    SizedBox(
                      ...
                      child: TextButton(
                        ...
                        style: TextButton.styleFrom(
                          backgroundColor:
                              const Color(0xFF1cfc03).withOpacity(0.6),
                        ...
                        child: Text(
                          pageIndex != 3 ? "Continue" : "Get me in",
