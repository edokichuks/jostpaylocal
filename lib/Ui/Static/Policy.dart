              ...
              child: Column(
                children: [
                  ...
                  const Padding(
                    padding: EdgeInsets.symmetric(horizontal: 24),
                    child: Text(
                      'Do we protect your information collect?',
                      style: MyStyle.tx36Grey,
                    ),
                  ),
                  const Padding(
                  ...
                  const Padding(
                    padding: EdgeInsets.symmetric(horizontal: 24),
                    child: Text(
                      'Data Retention and Third Parties Services',
                      style: MyStyle.tx36Grey,
                    ),
                  ),
                  const Padding(
                  ...
                  const Padding(
                      padding: EdgeInsets.all(24),
                      child: Text(
                        "You agree that this policy is governed by Nigeria laws, excluding the choice of law provisions thereof.",
                        style: MyStyle.tx18Grey,
                        textAlign: TextAlign.center,
                      )),
                  const SizedBox(
                  ...
                  const Padding(
                      padding: EdgeInsets.all(24),
                      child: Text(
                        "If we intend to amend our policies, we will post these updates to this page, and your continuing use of the Site will constitute your approval of this revised policy in such a situation. This Privacy Policy is effective as of june 24th, 2024.",
                        style: MyStyle.tx18Grey,
                        textAlign: TextAlign.center,
                      )),
                  const SizedBox(
                  ...
                  Padding(
                      ...
                      child: Text.rich(
                        TextSpan(children: [
                          const TextSpan(
                            text:
                                'If you have any questions regarding the Platform, please contact us at ',
                            style: MyStyle.tx18Grey,
                          ),
                          TextSpan(
