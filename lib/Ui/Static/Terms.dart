                  ...
                  Padding(
                      ...
                      child: Text.rich(
                        TextSpan(children: [
                          ...
                          TextSpan(
                            text:
                                ' is the website located at https://www.JostPay.com  which are owned and operated by JostPay, without limiting the generality of the foregoing and includes all subdomains and subpages, present and future. Without limiting the generality of the foregoing, or an app where the Platform services are accessed by a Logged-in User.',
                            style: MyStyle.tx14Black.copyWith(
                                fontWeight: FontWeight.w400,
                                color: MyColor.grey02Color),
                          ),
